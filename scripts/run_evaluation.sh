...
BASE_INPUT="/home/bjk/tool_learning/teach_to_tool_calling/experiment_results_edh/gpt-4o_hybrid_ours/valid_unseen"
BASE_OUTPUT="/home/bjk/tool_learning/teach_to_tool_calling/scripts/selected_500_gpt4o_hybrid_ours_edh_accuracy.jsonl"
...
python3 $PYTHON_SCRIPT \
    ...
    --experiment-name gpt4o_hybrid_ours_edh \
    --debug-missing
