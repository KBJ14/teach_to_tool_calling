...
EXPERIMENT_RESULTS_DIR="/home/bjk/tool_learning/teach_to_tool_calling/experiment_results_fc_summ_plus"
OUTPUT_BASE_DIR="/home/bjk/tool_learning/teach_to_tool_calling/scripts/accuracy"
EXPERIMENT_NAME="gpt-4o_semantic_fc_summ_plus"
...
# Iterate trial numbers 10..24
for TRIAL_NUMBER in {10..24}; do
    ...
    BASE_OUTPUT="$OUTPUT_DIR_TRIAL/selected_500_gpt-4o_semantic_fc_summ_plus_accuracy.jsonl"
