...
BASE_INPUT="/home/bjk/tool_learning/teach_to_tool_calling/dataset_experiments"
BASE_OUTPUT="/home/bjk/tool_learning/teach_to_tool_calling/experiment_results"
API_MODEL="gpt-4o"

echo "=== Starting API Inference for Model: $API_MODEL ==="


# 3. Hybrid Ours (가장 먼저 실행)
